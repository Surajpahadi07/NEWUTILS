    ...
    <div className={`mb-3 bg-${props.mode} ${props.mode === "light" ? "text-dark" : "text-light"}`}>
      ...
      <div className="container my-3">
        ...
        <div className="collapse" id="collapseExample">
          ...
          <div className="container">
            <div className="row">
                <button onClick={ReplacingOne} className="btn btn-outline-primary my-2 col-4" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2" >Replace</button>
                <div className="col-4"></div>
                <button onClick={ReplacingAll} className="btn btn-outline-primary my-2 col-4" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2" >Replace All</button>
            </div>
          </div>
      </div>
